...
## Referensi Visual
Untuk screen internal yang sifatnya authenticated app, bahasa visual yang harus diikuti adalah bahasa dashboard demo yang sudah ada di `src/app/(main)/dashboard/*`.
