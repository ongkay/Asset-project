...
- baseline schema, policy, trigger, view, dan RPC runtime ada di `migrations/001_extensions.sql` sampai `migrations/030_rpc.sql`; Milestone 7 user management juga membutuhkan `migrations/045_auth_admin_helpers.sql` untuk trusted auth-admin helper runtime
