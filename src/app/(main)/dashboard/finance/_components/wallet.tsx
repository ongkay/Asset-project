...
const walletCards = [
  { id: 1, bank: "Revolut Premium", last4: "4182", balance: "$12,450.60", icon: siRevolut },
  { id: 2, bank: "HSBC Bank", last4: "1004", balance: "$3,200.11", icon: siHsbc },
  { id: 3, bank: "Barclays Bank", last4: "9912", balance: "$1,450.00", icon: siBarclays },
];

const cryptoAssets = [
  { id: 1, name: "Bitcoin", vault: "Binance", balance: "0.42 BTC", usdValue: "$24,150.00", icon: siBitcoin },
  { id: 2, name: "Ethereum", vault: "MetaMask", balance: "4.85 ETH", usdValue: "$12,420.10", icon: siEthereum },
];
