...
export function AdminShellLayoutControls() {
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button size="icon" aria-label="Open layout controls">
          <Settings />
        </Button>
      </PopoverTrigger>
      <PopoverContent align="end">
        <div className="flex flex-col gap-5">
          <div className="space-y-1.5">
            ...
            <p className="text-muted-foreground text-xs">Adjust layout behavior, fonts, and theme presets.</p>
          </div>
                ...
                <SelectContent>
                  <SelectGroup>
                    {fontOptions.map((fontOption) => (
                      <SelectItem key={fontOption.key} className="text-xs" value={fontOption.key}>
                        {fontOption.label}
                      </SelectItem>
                    ))}
                  </SelectGroup>
