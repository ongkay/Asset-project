...
process.env.EXTENSION_ALLOWED_IDS ??= "ext-api-extension-id";
process.env.EXTENSION_ALLOWED_ORIGINS ??= "chrome-extension://ext-api-extension-id";
process.env.INVOICEKU_API_KEY ??= "invoiceku-api-key";
process.env.INVOICEKU_BASE_URL ??= "https://invoiceku.example.com/api/v1";
